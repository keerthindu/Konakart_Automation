...
public class TC07_ProceedToCheckout extends BaseClass{
    private static final Logger log = LogManager.getLogger("TC07_ProceedToCheckout");
    ...
    public void VerifyShopCart() throws Exception {
        ...
        captureScreenshot(driver,"TC07_ProceedToCheckout");
